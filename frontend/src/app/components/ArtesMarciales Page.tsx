import { Swords, Shield, Zap, Star, Shield as ShieldIcon, Layers, Building2, Hand } from "lucide-react";
...
export function ArtesMarciales Page() {
  return (
    <CatalogCategoryPage
      heroImage={HERO}
      ...
      related={[
        { title: "Equipos para el Combate", desc: "Cascos, protectores y equipamiento de protección integral para el contacto.", Icon: ShieldIcon, href: "/catalogo/equipos-para-el-combate" },
